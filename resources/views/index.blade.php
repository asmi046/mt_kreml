        ...
        <x-header></x-header>
            ...
            <div class="container left_text">
                <div class="bnr_text">
                    ...
                    <h2>Даты мероприятия: <br><strong>29.12.2024 и 03.01.2025</strong></h2>
                    <br>
                    <br>
            ...
            <div class="wrapper" id="price_app">
                ...
                <div class="pay_wrapper">
                    <tour-price title="Кремлевская ёлка 2025" img="{{asset('img/bn_present/4.jpg')}}"  :prices="{{json_encode([
                        ["price" => 9500, "comment" => "Цена для детей (Кремлевская Ёлка 29.12.2024)"],
                        ["price" => 8500, "comment" => "Цена для взрослых (Кремлевская Ёлка 29.12.2024)"],
                        ["price" => 9500, "comment" => "Цена для детей (Кремлевская Ёлка 03.01.2024)"],
                        ["price" => 8500, "comment" => "Цена для взрослых (Кремлевская Ёлка 03.01.2024)"],
                        ])}}"></tour-price>
                </div>
