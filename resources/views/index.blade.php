            ...
            <div class="wrapper" id="price_app">
                ...
                <div class="pay_wrapper">
                    <tour-price title="Кремлевская ёлка 2025" img="{{asset('img/bn_present/4.jpg')}}"  :prices="{{json_encode([
                        ...
                        ["price" => 11500, "comment" => "Цена для взрослых (Кремлевская Ёлка 27.12.2025)"],
                        ["price" => 11000, "comment" => "Цена для детей + подарок (Кремлевская Ёлка 27.12.2025)"],

                        ["price" => 11000, "comment" => "Для семей участников СВО взрослые 03.01.2026"],
                        ["price" => 11500, "comment" => "Для семей участников СВО дети + подарок <br>03.01.2026"],
